...
contract CarBlock {
    ...
    // This struct adds the renter's details and initiates rental
    ...
    function checkOut(address walletAddress) public {
        ...
        require(renters[walletAddress].canRent == true, "Can't rent now");
    ...
    function renterExisit (address walletAddress) public view returns (bool) {
